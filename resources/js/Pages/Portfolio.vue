<template>
  <div class="bg-white">
    ...
    >
      <div :key="content">
        <!-- Section Home -->
        <div v-if="content === 'home'" key="home">
          <Hero />
          <AristeeSection />
          <StackList />
        </div>
        <!-- Section CV -->
        <div v-if="content === 'cv'" key="cv">
          <CvSection />
        </div>
...
import Hero from "@/Components/TailwindUI/Hero.vue";
import AristeeSection from "@/Components/TailwindUI/AristeeSection.vue";
